    ...
    <div className="space-y-6">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <Link to="/practice/flashcards" className="card hover:border-blue-400">
          ...
          <div className="text-xs text-stone-600 mt-1">{flashcards.length} kartic · FSRS razporejanje · {stats.due} zapadlih</div>
        </Link>
        <Link to="/practice/quiz" className="card hover:border-blue-400">
          <div className="text-2xl mb-1">📝</div>
          <div className="font-semibold text-sm">Vprašanja</div>
          <div className="text-xs text-stone-600 mt-1">{quiz.length} vprašanj · MCQ + odprti odgovori + scenariji</div>
        </Link>
      </div>
