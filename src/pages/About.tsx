  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <section className="card">
        ...
        <ul className="text-sm list-disc pl-5 space-y-1.5 text-slate-700 dark:text-slate-300">
        ...
        <dl className="text-sm space-y-2">
          {glossary.map(g => (
            <div key={g.term}>
              ...
              <dd className="text-slate-600 dark:text-slate-300 text-xs">{g.sl}</dd>
            </div>
          ))}
        </dl>
      </section>
      ...
      <section className="card">
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300">
          Prijavi na: <a className="text-blue-600 dark:text-blue-400 underline" href="mailto:?subject=MVCP%20Academy%20—%20napaka%20v%20vsebini">e-pošta z opisom napake</a>
